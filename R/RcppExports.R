...
create_adult_mosquito_model <- function(growth_model, mu, tau, mosq_suppression, mosq_seasonality, emergence, use_Ace_mosq, susceptible) {
    .Call(`_malariasimulation_create_adult_mosquito_model`, growth_model, mu, tau, mosq_suppression, mosq_seasonality, emergence, use_Ace_mosq, susceptible)
}

adult_mosquito_model_update <- function(model, mu, foim, mosq_suppression, mosq_seasonality, emergence, use_Ace_mosq, susceptible, f) {
    invisible(.Call(`_malariasimulation_adult_mosquito_model_update`, model, mu, foim, mosq_suppression, mosq_seasonality, emergence, use_Ace_mosq, susceptible, f))
}
...
create_mosquito_model <- function(beta, de, mue, K0, gamma, dl, mul, dp, mup, use_Ace_mosq, total_M_orig, total_M, model_seasonality, g0, g, h, R_bar) {
    .Call(`_malariasimulation_create_mosquito_model`, beta, de, mue, K0, gamma, dl, mul, dp, mup, use_Ace_mosq, total_M_orig, total_M, model_seasonality, g0, g, h, R_bar)
}
