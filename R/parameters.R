...
get_parameters <- function(overrides = list(),square_number=square_number,run_number=run_number) {
  ...
  supp_filename_gamb<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/Apr 23 stoch/mosq_supp_het_stronger_gamb",square_number,"_",run_number,".csv",sep="")
  ...
  supp_filename_arab<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/Apr 23 stoch/mosq_supp_het_stronger_arab",square_number,"_",run_number,".csv",sep="")
  ...
  supp_filename_fun<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/Apr 23 stoch/mosq_supp_het_stronger_fun",square_number,"_",run_number,".csv",sep="")
  ...
  seas_filename_gamb<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/Apr 23 Emerge/mosq_seasonality_gamb",square_number,".csv",sep = "")
  ...
  seas_filename_arab<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/Apr 23 Emerge/mosq_seasonality_arab",square_number,".csv",sep = "")
  ...
  seas_filename_fun<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/Apr 23 Emerge/mosq_seasonality_fun",square_number,".csv",sep = "")
