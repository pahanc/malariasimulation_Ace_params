...
get_parameters <- function(overrides = list(),square_number=square_number) {
  ...
  supp_filename_gamb<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/Sept 22-2/mosq_supp_het_weaker_gamb",square_number,".csv",sep="")
  ...
  supp_filename_arab<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/Sept 22-2/mosq_supp_het_weaker_arab",square_number,".csv",sep="")
  ...
  supp_filename_fun<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/Sept 22-2/mosq_supp_het_weaker_fun",square_number,".csv",sep="")
