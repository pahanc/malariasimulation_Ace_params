...
get_parameters <- function(overrides = list(),square_number=square_number) {
  ...
  supp_filename_gamb<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/Sept 22-2/mosq_supp_hex_stronger_gamb",square_number,".csv",sep="")
  ...
  supp_filename_arab<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/Sept 22-2/mosq_supp_hex_stronger_arab",square_number,".csv",sep="")
  ...
  supp_filename_fun<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/Sept 22-2/mosq_supp_hex_stronger_fun",square_number,".csv",sep="")
  ...
  seas_filename_gamb<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/Sept 22/mosq_seasonality_gamb",square_number,".csv",sep = "")
  ...
  seas_filename_arab<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/Sept 22/mosq_seasonality_arab",square_number,".csv",sep = "")
  ...
  seas_filename_fun<-paste("Q:\\for_hpc\\Seas and supp species specific/With funestus suppression/Sept 22/mosq_seasonality_fun",square_number,".csv",sep = "")
