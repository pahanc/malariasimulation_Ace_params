...
get_parameters <- function(overrides = list(),square_number) {
  ...
  supp_filename_gamb<-paste("Seas and supp species specific/With funestus suppression/mosq_suppression_med_gamb",square_number,".csv",sep="")
  ...
  supp_filename_arab<-paste("Seas and supp species specific/With funestus suppression/mosq_suppression_med_arab",square_number,".csv",sep="")
  ...
  supp_filename_fun<-paste("Seas and supp species specific/With funestus suppression/mosq_suppression_med_fun",square_number,".csv",sep="")
  ...
  seas_filename_gamb<-paste("Seas and supp species specific/With funestus suppression/mosq_seasonality_med_gamb",square_number,".csv",sep = "")
  ...
  seas_filename_arab<-paste("Seas and supp species specific/With funestus suppression/mosq_seasonality_med_arab",square_number,".csv",sep = "")
  ...
  seas_filename_fun<-paste("Seas and supp species specific/With funestus suppression/mosq_seasonality_med_fun",square_number,".csv",sep = "")
